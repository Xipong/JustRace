...
UPGRADE_EFFECTS: Dict[str, Dict[str, float]] = {
    ...
    "intake": {"power": 0.02},
    "ecu": {"power": 0.04},
    "fuel": {"power": 0.03, "mass": 0.003},
    "cooling": {"power": 0.02, "mass": 0.004},
    "transmission": {"power": 0.02, "mass": -0.003},
    "suspension": {"tire_grip": 0.02, "mass": 0.004},
    "tires": {"tire_grip": 0.03, "mass": 0.003},
...
UPGRADE_DESCRIPTIONS = {
    "engine": "Повышает базовую мощность мотора, слегка увеличивая массу.",
    "turbo": "Устанавливает турбонаддув для прироста тяги, но увеличивает массу.",
    "exhaust": "Уменьшает сопротивление выпускной системы и снижает массу.",
    "intake": "Улучшает поступление воздуха в двигатель.",
    "ecu": "Перепрошивка блока управления для оптимальной работы.",
    "fuel": "Повышает эффективность подачи топлива, немного утяжеляя авто.",
    "cooling": "Снижает температуру двигателя под нагрузкой, увеличивая массу.",
    "transmission": "Ускоряет переключение передач и чуть снижает массу.",
    "suspension": "Улучшает управляемость на трассе, но делает машину тяжелее.",
    "tires": "Повышает сцепление с дорогой ценой добавленного веса.",
    "aero": "Снижает аэродинамическое сопротивление и массу.",
